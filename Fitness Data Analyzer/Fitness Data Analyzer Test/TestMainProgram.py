...
from TestCalculating import calculate_calories_burned
from TestFilteringPeople import filter_underweight_people
...
class TestMainProgram(unittest.TestCase):
    def test_people_data(self):
        ...
        expect = [{'duration': 60.0, 'height': 200, 'name': 'Zeus', 'weight': 90.0}]
