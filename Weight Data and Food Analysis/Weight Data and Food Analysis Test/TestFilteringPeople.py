...
class TestFilterOverWeightPeople(unittest.TestCase):
    def test_overweight_people(self):
        ...
        example = [{"duration": 20.0, "height": 1.90, "name": "John", "weight": 100.0}]
        expected = [{"duration": 20.0, "height": 1.90, "name": "John", "weight": 100.0}]
        message = "Not in bmi range"
...
class TestFilterObesityPeople(unittest.TestCase):
    def test_obesity_people(self):
        ...
        example = [{"duration": 20.0, "height": 1.90, "name": "John", "weight": 150.0}]
        expected = [{"duration": 20.0, "height": 1.90, "name": "John", "weight": 150.0}]
        message = "Not in bmi range"
